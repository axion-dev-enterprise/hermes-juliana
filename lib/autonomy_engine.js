...
function buildDynamicTools() {
  ...
  tools.push({
    ...
    function: {
      ...
      description: 'Permite ao agente/subagente alternar dinamicamente o modelo de IA utilizado caso perceba que o modelo atual não está sendo rápido, inteligente ou eficiente para a complexidade da tarefa (ex: deepseek/deepseek-r1:free, qwen/qwen-2.5-coder-32b-instruct:free, hermes-3-llama-3.1-405b, meta-llama/llama-3.3-70b-instruct:free, google/gemini-2.0-flash-exp:free, xiaomi/mimo-v2).',
      parameters: {
        type: 'object',
        properties: {
