const CONNECTORS = {
  ...
  github: {
    ...
    actions: {
      ...
      GET_REPOSITORY: { method: 'GET', path: '/repos/{{repository}}', risk: 'read', description: 'Obtém detalhes de um repositório específico (ex: axion-dev-enterprise/hermes-juliana).' },
