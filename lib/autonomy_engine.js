...
<body>
  <div class="container">
    ...
    if (!vercelDeployRes.ok && vercelDeployRes.status === 403) {
      ...
      vercelEndpoint = 'https://api.vercel.com/v13/deployments?skipAutoDetectionConfirmation=1&teamId=team_jKFR6U79Lc8DBlPK6RSk3RO5';
    ...
    const teamId = deployData.teamId || 'team_jKFR6U79Lc8DBlPK6RSk3RO5';
    try {
